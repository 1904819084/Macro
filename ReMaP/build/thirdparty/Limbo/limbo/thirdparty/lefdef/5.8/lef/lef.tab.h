...
#ifndef YY_LEFYY_USERS_BYTEDANCE_DOCUMENTS_TRAE_PROJECTS_REMAP_DAC25_REMAP_REMAP_BUILD_THIRDPARTY_LIMBO_LIMBO_THIRDPARTY_LEFDEF_5_8_LEF_LEF_TAB_H_INCLUDED
# define YY_LEFYY_USERS_BYTEDANCE_DOCUMENTS_TRAE_PROJECTS_REMAP_DAC25_REMAP_REMAP_BUILD_THIRDPARTY_LIMBO_LIMBO_THIRDPARTY_LEFDEF_5_8_LEF_LEF_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    K_PARALLELRUNLENGTH = 621,     /* K_PARALLELRUNLENGTH  */
    K_MINWIDTH = 622,              /* K_MINWIDTH  */
    K_PROTRUSIONWIDTH = 623,       /* K_PROTRUSIONWIDTH  */
    K_SPACINGTABLE = 624,          /* K_SPACINGTABLE  */
    K_WITHIN = 625,                /* K_WITHIN  */
    K_ABOVE = 626,                 /* K_ABOVE  */
    K_BELOW = 627,                 /* K_BELOW  */
    K_CENTERTOCENTER = 628,        /* K_CENTERTOCENTER  */
    K_CUTSIZE = 629,               /* K_CUTSIZE  */
    K_CUTSPACING = 630,            /* K_CUTSPACING  */
    K_DENSITY = 631,               /* K_DENSITY  */
    K_DIAG45 = 632,                /* K_DIAG45  */
    K_DIAG135 = 633,               /* K_DIAG135  */
    K_MASK = 634,                  /* K_MASK  */
    K_DIAGMINEDGELENGTH = 635,     /* K_DIAGMINEDGELENGTH  */
    K_DIAGSPACING = 636,           /* K_DIAGSPACING  */
    K_DIAGPITCH = 637,             /* K_DIAGPITCH  */
    K_DIAGWIDTH = 638,             /* K_DIAGWIDTH  */
    K_GENERATED = 639,             /* K_GENERATED  */
    K_GROUNDSENSITIVITY = 640,     /* K_GROUNDSENSITIVITY  */
    K_HARDSPACING = 641,           /* K_HARDSPACING  */
    K_INSIDECORNER = 642,          /* K_INSIDECORNER  */
    K_LAYERS = 643,                /* K_LAYERS  */
    K_LENGTHSUM = 644,             /* K_LENGTHSUM  */
    K_MICRONS = 645,               /* K_MICRONS  */
    K_MINCUTS = 646,               /* K_MINCUTS  */
    K_MINSIZE = 647,               /* K_MINSIZE  */
    K_NETEXPR = 648,               /* K_NETEXPR  */
    K_OUTSIDECORNER = 649,         /* K_OUTSIDECORNER  */
    K_PREFERENCLOSURE = 650,       /* K_PREFERENCLOSURE  */
    K_ROWCOL = 651,                /* K_ROWCOL  */
    K_ROWPATTERN = 652,            /* K_ROWPATTERN  */
    K_SOFT = 653,                  /* K_SOFT  */
    K_SUPPLYSENSITIVITY = 654,     /* K_SUPPLYSENSITIVITY  */
    K_USEVIA = 655,                /* K_USEVIA  */
    K_USEVIARULE = 656,            /* K_USEVIARULE  */
    K_WELLTAP = 657,               /* K_WELLTAP  */
    K_ARRAYCUTS = 658,             /* K_ARRAYCUTS  */
    K_ARRAYSPACING = 659,          /* K_ARRAYSPACING  */
    K_ANTENNAAREADIFFREDUCEPWL = 660, /* K_ANTENNAAREADIFFREDUCEPWL  */
    K_ANTENNAAREAMINUSDIFF = 661,  /* K_ANTENNAAREAMINUSDIFF  */
    K_ANTENNACUMROUTINGPLUSCUT = 662, /* K_ANTENNACUMROUTINGPLUSCUT  */
    K_ANTENNAGATEPLUSDIFF = 663,   /* K_ANTENNAGATEPLUSDIFF  */
    K_ENDOFLINE = 664,             /* K_ENDOFLINE  */
    K_ENDOFNOTCHWIDTH = 665,       /* K_ENDOFNOTCHWIDTH  */
    K_EXCEPTEXTRACUT = 666,        /* K_EXCEPTEXTRACUT  */
    K_EXCEPTSAMEPGNET = 667,       /* K_EXCEPTSAMEPGNET  */
    K_EXCEPTPGNET = 668,           /* K_EXCEPTPGNET  */
    K_LONGARRAY = 669,             /* K_LONGARRAY  */
    K_MAXEDGES = 670,              /* K_MAXEDGES  */
    K_NOTCHLENGTH = 671,           /* K_NOTCHLENGTH  */
    K_NOTCHSPACING = 672,          /* K_NOTCHSPACING  */
    K_ORTHOGONAL = 673,            /* K_ORTHOGONAL  */
    K_PARALLELEDGE = 674,          /* K_PARALLELEDGE  */
    K_PARALLELOVERLAP = 675,       /* K_PARALLELOVERLAP  */
    K_PGONLY = 676,                /* K_PGONLY  */
    K_PRL = 677,                   /* K_PRL  */
    K_TWOEDGES = 678,              /* K_TWOEDGES  */
    K_TWOWIDTHS = 679,             /* K_TWOWIDTHS  */
    IF = 680,                      /* IF  */
    LNOT = 681,                    /* LNOT  */
    UMINUS = 682                   /* UMINUS  */
  };
...
#line 498 "/Users/bytedance/Documents/trae_projects/Remap/DAC25-ReMaP/ReMaP/build/thirdparty/Limbo/limbo/thirdparty/lefdef/5.8/lef/lef.tab.h"
...
#endif /* !YY_LEFYY_USERS_BYTEDANCE_DOCUMENTS_TRAE_PROJECTS_REMAP_DAC25_REMAP_REMAP_BUILD_THIRDPARTY_LIMBO_LIMBO_THIRDPARTY_LEFDEF_5_8_LEF_LEF_TAB_H_INCLUDED  */
